...
export default function VideoDetailsSidebar({ setReviewModal }) {
  ...
  return (
    <>
      ...
      className={`h-[35px] w-[35px] items-center justify-center rounded-full  p-1 text-richblack-5 hover:scale-90 absolute z-50 transition-all duration-200 cursor-pointer -top-[47.5px] mr-2`}
      title="back">
